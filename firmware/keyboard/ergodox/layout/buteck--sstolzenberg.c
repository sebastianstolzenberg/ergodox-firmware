...
KEYS__DEFAULT(    SZ,             KEYBOARD__Dash_Underscore            );
KEYS__SHIFTED(    UE,             KEYBOARD__LeftBracket_LeftBrace      );
KEYS__SHIFTED(    OE,             KEYBOARD__Semicolon_Colon            );
KEYS__SHIFTED(    AE,             KEYBOARD__SingleQuote_DoubleQuote    );
...
KEYS__SHIFTED(    shiftEnter,     KEYBOARD__ReturnEnter                );
KEYS__SHIFTED(    shiftSpace,     KEYBOARD__Spacebar                   );
KEYS__SHIFTED(    shiftTab,       KEYBOARD__Tab                        );
